        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.kategori.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_kategori" class="form-control" required placeholder="Contoh: Obat Bebas">
                </div>
                <div class="mb-4">
                    <label class="form-label fw-bold">Deskripsi (Opsional)</label>
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Contoh: Obat yang dapat dibeli tanpa resep dokter."></textarea>
                </div>
